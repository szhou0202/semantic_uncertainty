...
def main(args):
    ...
    logging.info('Reuse inactive wandb id.')

    def restore(filename):
        class Restored:
            name = f'{wandb_dir}/wandb/run-20251119_144835-g5zubouf/files/{filename}'
        return Restored
    ...
    if args.analyze_run:
        ...
        logging.info(50 * '#X')
        logging.info('NOT STARTING `analyze_run`!')
        # analyze_run(wandb.run.id)
        logging.info(50 * '#X')
        logging.info('NOT FINISHED `analyze_run`!')
