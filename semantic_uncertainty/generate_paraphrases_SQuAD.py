...
def main(args):
    ...
    # Load data
    with open('data/dev-v2.0.json', 'r') as squad_dev:
        squad = json.load(squad_dev)
    
    squad = squad['data'] # list of dictionaries for each topic
    # Each topic in squads:
    # {
    # 'title': str , 
    # 'paragraphs': [{ 'qas': [{ 'question': str, 'id': str, 'answers': { 'text': str, 'answer_start': int }, 'is_impossible': Boolean }, ... ], 
    #                  'context': str }, ...]
    # }
