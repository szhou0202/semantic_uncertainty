...
def main(args):
    ...
    # szhou: This is what we need to change for multiple answers. 
    logging.info(80 * '=')
    ...
    for dataset_split in ['train', 'validation']:
        ...
        for index in tqdm(indices):
            ...
            questions, context = example["questions"], example['context']
            generations[example['id']] = {'questions': questions, 'context': context}
            correct_answer = example['answers']['text']

            # szhou: when we have multiple questions, the way we make a prompt changes
            # using original question to make prompt 
            ...
            for i in range(4): # szhou: hardcode to 4, 1 low-t, 3 high-t 
...
if __name__ == '__main__':
    ...
    if args.compute_uncertainties:
        ...
        torch.cuda.empty_cache()
        logging.info(50 * '#X')
        logging.info('NOT STARTING `compute_uncertainty_measures`!')
        # main_compute(args)
        logging.info('NOT FINISHED `compute_uncertainty_measures`!')
